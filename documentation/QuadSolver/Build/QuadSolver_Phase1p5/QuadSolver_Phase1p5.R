QuadSolver_Phase1p5 <- function(x) {
  ...
  if (a_convert > 0.0) {
    ...
    if(a_convert < 2.0^-149 || a_convert > ((2.0-2.0^-23) * 2.0^127)) {
      values <- c(a, b, c)
  ...
  else if (a_convert < 0.0) {
    
    if(a_convert < (-(2.0-2.0^-23) * 2^127) || a_convert > -2.0^-149) {
      values <- c(a, b, c)
  ...
  if (b_convert > 0.0) {
    ...
    if(b_convert < 2.0^-149 || b_convert > ((2.0-2.0^-23) * 2.0^127)) {
      values <- c(a, b, c)
  ...
  else if (b_convert < 0.0) {
    
    if(b_convert < (-(2.0-2.0^-23) * 2.0^127) || b_convert > -2.0^-149) {
      values <- c(a, b, c)
  ...
  if (c_convert > 0.0) {
    ...
    if(c_convert < 2.0^-149 || c_convert > ((2.0-2.0^-23) * 2.0^127)) {
      values <- c(a, b, c)
  ...
  else if (c_convert < 0.0) {
    
    if(c_convert < (-(2.0-2.0^-23) * 2.0^127) || c_convert > -2.0^-149) {
      values <- c(a, b, c)
  ...
  if (a_convert != 0.0 && b_convert != 0.0 && c_convert != 0.0) {
    
    det_val <- (b_convert * b_convert) - (4.0 * a_convert * c_convert)
  ...
  if (det_val > 0.0) {
    ...
    x1 <- (-b_convert + sqrt(det_val))/ (2.0 * a_convert)
    
    x2 <- (-b_convert - sqrt(det_val))/ (2.0 * a_convert)
  ...
  # - if FALSE, the equation's solutions are returned
    ...
    x <- (-b_convert + sqrt(det_val))/(2.0 * a_convert)
