...
#### Description: User-prompt for input. Inputted string is broke into values a, b, and c.
#                 The values are converted to the numeric format and stored in the values 
#                 object. 
